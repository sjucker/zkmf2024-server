...
public class JudgeReportRatingDao extends DAOImpl<JudgeReportRatingRecord, JudgeReportRatingPojo, Long> {
    ...
    @Override
    public Long getId(JudgeReportRatingPojo object) {
        return object.getId();
    }
     ...
     * upperInclusive</code>
     */
    public List<JudgeReportRatingPojo> fetchRangeOfId(Long lowerInclusive, Long upperInclusive) {
        return fetchRange(JudgeReportRating.JUDGE_REPORT_RATING.ID, lowerInclusive, upperInclusive);
    }

    /**
     * Fetch records that have <code>id IN (values)</code>
     */
    public List<JudgeReportRatingPojo> fetchById(Long... values) {
        return fetch(JudgeReportRating.JUDGE_REPORT_RATING.ID, values);
    }

    /**
     * Fetch a unique record that has <code>id = value</code>
     */
    public JudgeReportRatingPojo fetchOneById(Long value) {
        return fetchOne(JudgeReportRating.JUDGE_REPORT_RATING.ID, value);
    }

    /**
     * Fetch a unique record that has <code>id = value</code>
     */
    public Optional<JudgeReportRatingPojo> fetchOptionalById(Long value) {
        return fetchOptional(JudgeReportRating.JUDGE_REPORT_RATING.ID, value);
    }
