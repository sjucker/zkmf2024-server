...
public class TimetableEntryRecord extends UpdatableRecordImpl<TimetableEntryRecord> implements Record7<Long, Long, Long, Long, LocalDate, LocalTime, LocalTime>, ITimetableEntry {
    ...
    @Override
    public Row7<Long, Long, Long, Long, LocalDate, LocalTime, LocalTime> valuesRow() {
    ...
    @Override
    public TimetableEntryRecord values(Long value1, Long value2, Long value3, Long value4, LocalDate value5, LocalTime value6, LocalTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TimetableEntryRecord(Long id, Long fkVerein, Long fkVereinProgramm, Long fkLocation, LocalDate date, LocalTime startTime, LocalTime endTime) {
        super(TimetableEntry.TIMETABLE_ENTRY);
