...
public class Keys {
    ...
    public static final UniqueKey<JudgeReportRecord> JUDGE_REPORT_FK_JUDGE_FK_TIMETABLE_ENTRY_KEY = Internal.createUniqueKey(JudgeReport.JUDGE_REPORT, DSL.name("judge_report_fk_judge_fk_timetable_entry_key"), new TableField[]{JudgeReport.JUDGE_REPORT.FK_JUDGE, JudgeReport.JUDGE_REPORT.FK_TIMETABLE_ENTRY}, true);
    ...
    public static final UniqueKey<TimetableEntryRecord> TIMETABLE_ENTRY_FK_VEREIN_FK_VEREIN_PROGRAMM_KEY = Internal.createUniqueKey(TimetableEntry.TIMETABLE_ENTRY, DSL.name("timetable_entry_fk_verein_fk_verein_programm_key"), new TableField[]{TimetableEntry.TIMETABLE_ENTRY.FK_VEREIN, TimetableEntry.TIMETABLE_ENTRY.FK_VEREIN_PROGRAMM}, true);
