...
public class Keys {
    ...
    public static final UniqueKey<TimetableEntryRecord> KEY_TIMETABLE_ENTRY_UQ_TIMETABLE = Internal.createUniqueKey(TimetableEntry.TIMETABLE_ENTRY, DSL.name("KEY_timetable_entry_uq_timetable"), new TableField[]{TimetableEntry.TIMETABLE_ENTRY.FK_VEREIN, TimetableEntry.TIMETABLE_ENTRY.FK_VEREIN_PROGRAMM}, true);
