...
public class LocationRecord extends UpdatableRecordImpl<LocationRecord> implements Record12<Long, String, String, BigDecimal, BigDecimal, LocationLocationType, String, String, Long, Long, Long, Integer>, ILocation {
    ...
    @Override
    public Row12<Long, String, String, BigDecimal, BigDecimal, LocationLocationType, String, String, Long, Long, Long, Integer> valuesRow() {
     ...
     */
    public LocationRecord(Long id, String name, String address, BigDecimal latitude, BigDecimal longitude, LocationLocationType locationType, String capacity, String modules, Long einspiellokalId, Long instrumentendepotId, Long juryfeedbackId, Integer sortOrder) {
        super(Location.LOCATION);
