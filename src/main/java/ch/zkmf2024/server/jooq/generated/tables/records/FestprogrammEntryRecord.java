...
public class FestprogrammEntryRecord extends UpdatableRecordImpl<FestprogrammEntryRecord> implements Record6<Long, LocalDate, LocalTime, String, String, Boolean>, IFestprogrammEntry {
    ...
    @Override
    public Row6<Long, LocalDate, LocalTime, String, String, Boolean> valuesRow() {
    ...
    @Override
    public FestprogrammEntryRecord values(Long value1, LocalDate value2, LocalTime value3, String value4, String value5, Boolean value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public FestprogrammEntryRecord(Long id, LocalDate date, LocalTime startTime, String description, String location, Boolean important) {
        super(FestprogrammEntry.FESTPROGRAMM_ENTRY);
