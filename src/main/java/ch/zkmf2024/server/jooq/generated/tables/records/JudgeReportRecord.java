...
public class JudgeReportRecord extends UpdatableRecordImpl<JudgeReportRecord> implements Record8<Long, Long, Long, Integer, String, LocalDateTime, Boolean, String>, IJudgeReport {
    ...
    @Override
    public Row8<Long, Long, Long, Integer, String, LocalDateTime, Boolean, String> valuesRow() {
    ...
    @Override
    public JudgeReportRecord values(Long value1, Long value2, Long value3, Integer value4, String value5, LocalDateTime value6, Boolean value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JudgeReportRecord(Long id, Long fkJudge, Long fkTimetableEntry, Integer score, String status, LocalDateTime finishedAt, Boolean ratingFixed, String role) {
        super(JudgeReport.JUDGE_REPORT);
