...
public class JudgeReportRecord extends UpdatableRecordImpl<JudgeReportRecord> implements Record6<Long, Long, Long, Integer, String, LocalDateTime>, IJudgeReport {
    ...
    @Override
    public Row6<Long, Long, Long, Integer, String, LocalDateTime> valuesRow() {
    ...
    @Override
    public JudgeReportRecord values(Long value1, Long value2, Long value3, Integer value4, String value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JudgeReportRecord(Long id, Long fkJudge, Long fkTimetableEntry, Integer score, String status, LocalDateTime finishedAt) {
        super(JudgeReport.JUDGE_REPORT);
