...
public class JudgeReportRecord extends UpdatableRecordImpl<JudgeReportRecord> implements Record6<Long, Long, Long, Integer, String, OffsetDateTime>, IJudgeReport {
    ...
    @Override
    public Row6<Long, Long, Long, Integer, String, OffsetDateTime> valuesRow() {
    ...
    @Override
    public JudgeReportRecord value6(OffsetDateTime value) {
        setFinishedAt(value);
        return this;
    }

    @Override
    public JudgeReportRecord values(Long value1, Long value2, Long value3, Integer value4, String value5, OffsetDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JudgeReportRecord(Long id, Long fkJudge, Long fkTimetableEntry, Integer score, String status, OffsetDateTime finishedAt) {
        super(JudgeReport.JUDGE_REPORT);
