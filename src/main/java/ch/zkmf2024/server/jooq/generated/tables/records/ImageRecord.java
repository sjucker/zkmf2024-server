...
public class ImageRecord extends UpdatableRecordImpl<ImageRecord> implements Record6<Long, Long, byte[], String, LocalDateTime, String>, IImage {
    ...
    @Override
    public Row6<Long, Long, byte[], String, LocalDateTime, String> valuesRow() {
    ...
    @Override
    public ImageRecord values(Long value1, Long value2, byte[] value3, String value4, LocalDateTime value5, String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ImageRecord(Long id, Long foreignKey, byte[] content, String name, LocalDateTime uploadedAt, String type) {
        super(Image.IMAGE);
