...
public class JudgeReportRating extends TableImpl<JudgeReportRatingRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super Long, ? super Long, ? super Long, ? super String, ? super String, ? super String, ? super BigDecimal, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function7<? super Long, ? super Long, ? super Long, ? super String, ? super String, ? super String, ? super BigDecimal, ? extends U> from) {
