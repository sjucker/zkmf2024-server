...
public class Ranking extends TableImpl<RankingRecord> {
    ...
    public List<ForeignKey<RankingRecord, ?>> getReferences() {
        return Arrays.asList(Keys.RANKING__FK_RANKING_LOCATION);
    }
    ...
    public LocationPath location() {
        if (_location == null)
            _location = new LocationPath(this, Keys.RANKING__FK_RANKING_LOCATION, null);
    ...
    /**
     * Get the implicit many-to-many join path to the <code>public.verein</code>
     * table
     */
    public VereinPath verein() {
        return rankingEntry().verein();
    }
